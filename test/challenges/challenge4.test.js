...
describe('challenge4', function() {
  ...
  it('places the pirate after treasure when both found', function() {
    ...
    return expect(treasureIndex).to.be.lessThan(pirateIndex);
  });
  ...
  it('marks the treasure as not stolen when found and pirate not found', function() {
    var a, challenge;
  ...
  return describe('marks the treasure as not stolen if treasure not found', function() {
    ...
    return it('pirate not found', function() {
      var a, challenge;
      challenge = subject.getChallenge(false, false);
      a = challenge.answer;
      return expect(a.treasureStolen).to.be["false"];
